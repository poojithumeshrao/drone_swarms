...
if(NOT "include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/poojith/catkin_ws/install_isolated/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/poojith/catkin_ws/install_isolated/lib;/home/poojith/catkin_ws/devel_isolated/mavros_msgs/lib;/home/poojith/catkin_ws/devel_isolated/libmavconn/lib;/home/poojith/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
